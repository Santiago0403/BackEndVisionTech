...
public class NumeroEmergenciaController {
    ...
    public ResponseEntity<Map<String, Object>> cantidadTotalDistritos() {
        Long totalDistritos = nS.countNumeroEmergenciaPorDistrito();

        Map<String, Object> response = new HashMap<>();
        response.put("total_distritos", totalDistritos);
